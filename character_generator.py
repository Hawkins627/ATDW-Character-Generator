...
if st.button("📜 Generate Character Sheet"):
    ...
    fields = {
    	...
    	"tf_personality_background": str(bg["background"].split(" - ")[0]) if bg is not None else "",
	    ...
	    "tf_personality": "",  # intentionally blank (no such field, but placeholder for clarity)
